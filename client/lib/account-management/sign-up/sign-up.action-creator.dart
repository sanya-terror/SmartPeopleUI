...
class SignUpActionCreator {
  ...
  static Action sendSignUpData(signUpData) =>
      ApiActionCreator.postApiAction(SIGN_UP_SEND_DATA, '/users/sign-up/create-account', {'signUpData': signUpData}, false);

  static Action resendConfirmCode(String token) =>
      ApiActionCreator.postApiAction(SIGN_UP_RESEND_CONFIRM_CODE, '/users/sign-up/resend-code', {'token': token}, false);
