    ...
    group('Change password component', () {
      ...
      group('On state change', () {
        ...
        test('Should not dispatch any action if receive error on changing password', () async {
          ...
          expect(verify(mockStore.dispatch(anything)).callCount,
              1); // one action dispatch is called during component.applyPasswordChanging()
        });
      ...
      test('Should apply changing password', () {
        ...
        when(mockStore.state)
            .thenReturn(new State({'restoreAccess': new RestoreAccessData()..changePasswordToken = token}));
