...
import 'package:smartpeople_client/shared/components/controls/dialog/dialog-manager.dart';
...
class UnhandledErrorTests {
      ...
      group('On state change', () {
        ...
        test('Should store error details', () {
          ...
          var newState = new State(
              {'isBadRequestError': true, 'errorMessage': 'Error message', 'errorStackTrace': someError.stackTrace});
  ...
  static _mockSubscription(mockStore) {
    ...
    var hasUnhandledError =
        predicate((f) => f(new State({'isBadRequestError': {}})) && f(new State({'isInternalServerError': {}})));
