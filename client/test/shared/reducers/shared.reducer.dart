...
import 'package:smartpeople_client/index.dart' show SharedReducer, SAVE_EMAIL, SIGN_UP_RESEND_CONFIRM_CODE;
      ...
      List<Map<String, dynamic>> cases = [
        {
          ...
          'result': new State({'some': 'property', 'email': 'test@test.com'})
        }
      ];
