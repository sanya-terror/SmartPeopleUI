...
class SignUpActionCreator {
  ...
  static Action sendSignUpData(signUpData) =>
      ApiActionCreator.postApiAction(SIGN_UP_SEND_DATA, '/handleSignUpData', {'signUpData': signUpData}, false);

  static Action resendConfirmCode(String token) =>
      ApiActionCreator.postApiAction(SIGN_UP_RESEND_CONFIRM_CODE, '/resendConfirmCode', {'token': token}, false);

  static Action applyConfirmationCode(String code) =>
      ApiActionCreator.postApiAction(SIGN_UP_APPLY_CONFIRMATION_CODE, '/applyConfirmationCode', {'code': code}, false);
